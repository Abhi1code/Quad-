...
#define MAX_PULSE_LENGTH 1500 // Maximum pulse length in µs
// ---------------------------------------------------------------------------
...
void setup() {
    ...
    motA.attach(4, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH+500);
    //motB.attach(5, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH+500);
    //motC.attach(6, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH+500);
    //motD.attach(7, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH+500);
    ...
    if (Serial.available()) {
        ...
        switch (data) {
            ...
            case 49 : Serial.println("Sending maximum throttle");
                      motA.writeMicroseconds(MAX_PULSE_LENGTH+500);
                      //motB.writeMicroseconds(MAX_PULSE_LENGTH+500);
                      //motC.writeMicroseconds(MAX_PULSE_LENGTH+500);
                      //motD.writeMicroseconds(MAX_PULSE_LENGTH+500);
            break;
            ...
            //case 51 : motA.writeMicroseconds(2000);
            //break;
        }
    }
...
void test()
{
    for (int i = MIN_PULSE_LENGTH; i <= 1500; i += 5) {
